  ...
  class u {
    ...
    off(e, t) {
      this.userEventsList &&
        ...
        (t
          ? this.userEventsList[e].forEach((i, o) => {
    ...
    play(e) {
      ...
      t.player &&
        ("youtube" === t.type &&
          ...
          i.YT.PlayerState.PLAYING !== t.player.getPlayerState() &&
            t.player.playVideo()),
        "vimeo" === t.type &&
    ...
    pause() {
      ...
      e.player &&
        ("youtube" === e.type &&
          e.player.pauseVideo &&
          i.YT.PlayerState.PLAYING === e.player.getPlayerState() &&
          e.player.pauseVideo(),
        "vimeo" === e.type &&
    ...
    getImageURL(e) {
      ...
      if ("youtube" === t.type) {
        ...
        (a.onload = function () {
          120 !== (this.naturalWidth || this.width) || o === i.length - 1
            ? ((t.videoImage = `https://img.youtube.com/vi/${t.videoID}/${i[o]}.jpg`),
              e(t.videoImage))
            : ((o += 1),
      ...
      if ("vimeo" === t.type) {
        ...
        l.open("GET", `https://vimeo.com/api/oembed.json?url=${t.url}`, !0),
          (l.onreadystatechange = function () {
            if (
              ...
              i.thumbnail_url &&
                ((t.videoImage = i.thumbnail_url), e(t.videoImage));
            }
          }),
          l.send(),
          (l = null);
    ...
    getVideo(e) {
      ...
      t.onAPIready(() => {
        ...
        if (
          ...
          t.playerOptions.events = {
            onReady(e) {
              t.options.mute
                ? e.target.mute()
                : t.options.volume && e.target.setVolume(t.options.volume),
                t.options.autoplay && t.play(t.options.startTime),
                t.fire("ready", e),
                t.options.loop &&
                  !t.options.endTime &&
                  (t.options.endTime = t.player.getDuration() - 0.1),
                setInterval(() => {
                  t.getVolume((i) => {
                    t.options.volume !== i &&
                      ((t.options.volume = i), t.fire("volumechange", e));
                  });
                }, 150);
            },
            onStateChange(e) {
              t.options.loop &&
                e.data === i.YT.PlayerState.ENDED &&
                t.play(t.options.startTime),
                a ||
                  e.data !== i.YT.PlayerState.PLAYING ||
                  ((a = 1), t.fire("started", e)),
                e.data === i.YT.PlayerState.PLAYING && t.fire("play", e),
                e.data === i.YT.PlayerState.PAUSED && t.fire("pause", e),
                e.data === i.YT.PlayerState.ENDED && t.fire("ended", e),
                e.data === i.YT.PlayerState.PLAYING
                  ? (l = setInterval(() => {
                      t.fire("timeupdate", e),
                        t.options.endTime &&
          ...
          if (r) {
            ...
            s.setAttribute("id", t.playerID),
              o.appendChild(s),
              document.body.appendChild(o);
          }
          (t.player = t.player || new i.YT.Player(t.playerID, t.playerOptions)),
            r &&
        ...
        if ("vimeo" === t.type) {
          ...
          (t.player =
            t.player || new i.Vimeo.Player(t.$video, t.playerOptions)),
            t.options.startTime &&
              t.options.autoplay &&
    ...
    onAPIready(e) {
      if (
        ("youtube" === this.type &&
          ((void 0 !== i.YT && 0 !== i.YT.loaded) || s
            ? "object" == typeof i.YT && 1 === i.YT.loaded
              ? e()
              : p.done(() => {
                  e();
                })
  ...
  function v(e = m.jarallax) {
    ...
    t.prototype.coverImage = function () {
      ...
      if (e && this.video && t && ("IFRAME" === t || "VIDEO" === t)) {
        ...
        e.container.width > a &&
          ((i =
            ((a = e.container.width) * this.image.height) / this.image.width),
          (l = 0),
    ...
    t.prototype.initImg = function () {
      let e = this,
        t = a.apply(e);
      return (e.options.videoSrc ||
        (e.options.videoSrc =
          e.$item.getAttribute("data-jarallax-video") || null),
      e.options.videoSrc)
        ? ((e.defaultInitImgResult = t), !0)
        : t;
    };
    ...
    t.prototype.canInitParallax = function () {
      ...
      if (
        (e.options.onVideoWorkerInit && e.options.onVideoWorkerInit.call(e, i),
        i.isValid())
      ) {
        if (
 ...
 */ !(function (t, e) {
  ...
  function o(t = i.jarallax) {
    ...
    [
      ...
      e.prototype[t] = function (...e) {
        ...
        if (
          ("initImg" === t &&
            null !== o.$item.getAttribute("data-jarallax-element") &&
            ((o.options.type = "element"),
            (o.pureOptions.speed =
              o.$item.getAttribute("data-jarallax-element") || "100")),
          "element" !== o.options.type)
        )
          return i.apply(o, e);
        switch (
          ((o.pureOptions.threshold =
            o.$item.getAttribute("data-threshold") || ""),
          t)
        ) {
          case "init": {
            ...
            return s && o.$item.setAttribute("style", s), !0;
          }
          case "onResize": {
            let l = o.css(o.$item, "transform");
            o.css(o.$item, { transform: "" });
            let r = o.$item.getBoundingClientRect();
            (o.itemData = {
              width: r.width,
              height: r.height,
              ...
              o.css(o.$item, { transform: l });
            break;
          }
          case "onScroll": {
            let p = o.getWindowData(),
              d =
                (p.y + p.height / 2 - o.itemData.y - o.itemData.height / 2) /
                (p.height / 2),
              u = d * o.options.speedY,
              h = d * o.options.speedX,
              c = u,
              m = h;
            null !== o.options.thresholdY &&
              u > o.options.thresholdY &&
              (c = 0),
              null !== o.options.thresholdX &&
                h > o.options.thresholdX &&
                (m = 0),
              o.css(o.$item, { transform: `translate3d(${m}px,${c}px,0)` });
            break;
          }
          case "initImg":
          case "isVisible":
  ...
  return (
    ...
    (e = () => {
      void 0 !== i.jarallax &&
        i.jarallax(document.querySelectorAll("[data-jarallax-element]"));
    }),
    "complete" === document.readyState || "interactive" === document.readyState
      ? e()
      : document.addEventListener("DOMContentLoaded", e, {
...
!(function (t, e) {
    ...
    jt = function _initTween(t, e) {
      ...
      if (
        ...
        if (
          ...
          (r = ta(_, lt)),
          S && (S.revert(M && C ? ht : ut), (S._lazy = 0)),
          g)
        ) {
          if (
            (ya(
    ...
    function Tween(e, r, i, n) {
      ...
      if (
        ...
        if (
          ((r = a.vars),
          (s = a.timeline =
            new Qt({ data: "nested", defaults: M || {} })).kill(),
        ...
        return (
          this.data.forEach(function (t) {
            return t instanceof Context
              ...
              : t instanceof $t &&
                  t._targets[0] !== t.vars.onComplete &&
                  e.push(t);
          }),
          e
        );
  ...
  function Id() {
    ...
    if (this.tfm) {
      for (e in (a.svg && i.setAttribute("transform", this.svg || ""),
      this.tfm))
        a[e] = this.tfm[e];
  ...
  var we,
    ...
    je = {
      ...
      sc: F(function (e) {
        return arguments.length
          ? ke.scrollTo(e, Je.sc())
          : ke.pageXOffset || Me[r] || Ae[r] || Ee[r] || 0;
      }),
    },
    Je = {
      s: n,
      ...
      sc: F(function (e) {
        return arguments.length
          ? ke.scrollTo(je.sc(), e)
          : ke.pageYOffset || Me[n] || Ae[n] || Ee[n] || 0;
      }),
    };
  (je.op = Je), (k.cache = 0);
  var P =
  ...
  function $b(e, t, r, n, i, o, a, s, l, c, u, f, d) {
    ...
    if (o) {
      ...
      (p = "scroll" + n.d2),
        ...
        u &&
          ((l = Ct(a)),
          u && (o.style[n.op.p] = l[n.op.p] - n.op.m - o._offset + Et));
    }
    return (
      d &&
        h &&
          ...
          if (
            ...
            (C = this.markerStart = tb("start", a, f, ge, e, t, 0, fe)),
              ...
              me ||
                ...
                (x = Ge.quickSetter(B, ge.a, Et)),
                (w = Ge.quickSetter(z, ge.a, Et)));
          }
          if (fe) {
              ...
              if ((!at && Se.enabled) || t)
                if (ie && e && vt) mb(ScrollTrigger, "scrollEnd", Eb);
                  ...
                  for (
                    Ja(y) && (y = y(Se)),
                      A =
                        $b(y, ne, d, ge, Ae(), C, B, Se, p, we, me, g, fe) ||
                        (ie ? -0.001 : 0),
                      Ja(v) && (v = v(Se)),
                      Ia(v) &&
                        !v.indexOf("+=") &&
                  ...
                  if (
                    ...
                    (r = cb(ie)),
                      ...
                      me &&
                        ...
                        (a[wt] = a.maxHeight = Math.ceil(n.height) + Et),
                        (a[Mt] =
                          a[Mt + Tt] =
                          a[Mt + St] =
                          a[Mt + kt] =
                  ...
                  f &&
                    ...
                    (Se.end = E),
                    (P = M = Ae()),
                    fe || (P < U && Ae(U), (Se.scroll.rec = 0)),
                    Se.revert(!1, !0),
                    G &&
                      ((Pe = -1), Se.isActive && Ae(A + D * K), G.restart(!0)),
                    (at = 0),
                    T &&
                      he &&
                      (T._initted || q) &&
          ...
          (mt = 1),
            ...
            Ge.matchMedia
              ? ((ScrollTrigger.matchMedia = function (e) {
                  var t, r;
                  for (r in e)
                    t ? t.add(r, e[r]) : (t = Ge.matchMedia(r, e[r]));
                  return t;
                }),
  ...
  function i(t, e, a) {
    ...
    if (
      ...
      "object" == typeof e.locale &&
        ...
        "string" == typeof e.locale.customRangeLabel &&
          (((h = document.createElement("textarea")).innerHTML =
      ...
      for (var o = this.locale.firstDay; 0 < o; )
    ...
    if (
      (void 0 === e.startDate &&
        ...
        ((r = i = null),
        2 ==
        (t = (n = L(this.element).val()).split(this.locale.separator)).length
          ? ((r = A(t[0], this.locale.format)),
            (i = A(t[1], this.locale.format)))
          : this.singleDatePicker &&
            "" !== n &&
            ((r = A(n, this.locale.format)), (i = A(n, this.locale.format))),
        null !== r && null !== i && (this.setStartDate(r), this.setEndDate(i))),
      "object" == typeof e.ranges)
    ) {
      for (s in e.ranges) {
        (r =
          "string" == typeof e.ranges[s][0]
            ? A(e.ranges[s][0], this.locale.format)
            : A(e.ranges[s][0])),
          (i =
            "string" == typeof e.ranges[s][1]
              ? A(e.ranges[s][1], this.locale.format)
              : A(e.ranges[s][1])),
          this.minDate &&
        ...
        this.maxSpan &&
          c &&
          r.clone().add(this.maxSpan).isAfter(c) &&
          (c = r.clone().add(this.maxSpan)),
          c && i.isAfter(c) && (i = c.clone()),
          (this.minDate &&
            i.isBefore(this.minDate, this.timepicker ? "minute" : "day")) ||
            (c && r.isAfter(c, this.timepicker ? "minute" : "day")) ||
            (((h = document.createElement("textarea")).innerHTML = s),
            (l = h.value),
            (this.ranges[l] = [r, i]));
      }
      var d = "<ul>";
      for (s in this.ranges)
        d += '<li data-range-key="' + s + '">' + s + "</li>";
  ...
  return (
    (i.prototype = {
      ...
      renderCalendar: function (t) {
        ...
        for (
          var m = A([i, c, l, 12, n, r]), d = 0, p = 0, f = 0;
          d < 42;
          ...
          for (
            ...
            (!C || (u && w >= u.month())) && (!v || (D && w <= D.month()))
              ...
              : (Y +=
                  ...
                  "</option>");
          Y += "</select>";
          for (var P = '<select class="yearselect">', x = l; x <= b; x++)
            P +=
              '<option value="' +
              x +
              '"' +
        ...
        (g += '<th colspan="5" class="month">' + c + "</th>"),
          ...
          null == this.endDate &&
            this.maxSpan &&
            ((c = this.startDate.clone().add(this.maxSpan).endOf("day")),
            (D && !c.isBefore(D)) || (D = c));
        for (f = 0; f < 6; f++) {
          (g += "<tr>"),
          ...
          for (p = 0; p < 7; p++) {
            ...
            for (var S = "", B = !1, d = 0; d < M.length; d++)
        ...
        if ("right" != t || this.endDate) {
            ...
            "left" == t
              ...
              : "right" == t &&
                ...
                "" !=
                  ...
                  this.timePicker24Hour ||
                    ("PM" ===
                      (d = n.find(".ampmselect option:selected").val()) &&
                      a.hour() < 12 &&
                      a.hour(a.hour() + 12),
                    "AM" === d && 12 === a.hour() && a.hour(0))),
                a.isBefore(this.startDate) && (a = this.startDate.clone()),
                s && a.isAfter(s) && (a = s.clone())),
            (e = '<select class="hourselect">');
          for (
            var n = this.timePicker24Hour ? 0 : 1,
              r = this.timePicker24Hour ? 23 : 12,
              o = n;
            o <= r;
            o++
          ) {
            var h = o;
            this.timePicker24Hour ||
              (h = 12 <= a.hour() ? (12 == o ? 12 : o + 12) : 12 == o ? 0 : o);
            var l = a.clone().hour(h),
              c = !1;
            i && l.minute(59).isBefore(i) && (c = !0),
              s && l.minute(0).isAfter(s) && (c = !0),
              h != a.hour() || c
                ? (e += c
                    ? '<option value="' +
                      o +
          ...
          for (var d, o = 0; o < 60; o += this.timePickerIncrement) {
            var m = o < 10 ? "0" + o : o,
              l = a.clone().minute(o),
              c = !1;
            i && l.second(59).isBefore(i) && (c = !0),
              s && l.second(0).isAfter(s) && (c = !0),
              a.minute() != o || c
                ? (e += c
                    ? '<option value="' +
                      o +
          ...
          this.timePicker24Hour ||
            ...
            i &&
              ...
              (d = ' disabled="disabled" class="disabled"'),
            s &&
        ...
        L(t.target).hasClass("available") &&
          ...
          this.endDate ||
            this.container.find(".drp-calendar tbody td").each(function (t, e) {
              var a, i;
              L(e).hasClass("week") ||
                ((a = (i = L(e).attr("data-title")).substr(1, 1)),
                (i = i.substr(3, 1)),
                ((i = (L(e).parents(".drp-calendar").hasClass("left") ? n : r)
                  .calendar[a][i]).isAfter(o) &&
                  i.isBefore(s)) ||
                i.isSame(s, "day")
      ...
      clickDate: function (t) {
        ...
        L(t.target).hasClass("available") &&
          ...
          this.endDate || a.isBefore(this.startDate, "day")
            ? (this.timePicker &&
                ((i = parseInt(
                  this.container.find(".left .hourselect").val(),
                  10
                ...
                (r = this.timePickerSeconds
                  ...
                  : 0),
                (a = a.clone().hour(i).minute(n).second(r))),
              (this.endDate = null),
              this.setStartDate(a.clone()))
            : !this.endDate && a.isBefore(this.startDate)
      ...
      monthOrYearChanged: function (t) {
        ...
        e ||
          ((t < this.startDate.year() ||
            (t == this.startDate.year() && a < this.startDate.month())) &&
            ((a = this.startDate.month()), (t = this.startDate.year()))),
          this.minDate &&
            (t < this.minDate.year() ||
              (t == this.minDate.year() && a < this.minDate.month())) &&
            ((a = this.minDate.month()), (t = this.minDate.year())),
          this.maxDate &&
            (t > this.maxDate.year() ||
              (t == this.maxDate.year() && a > this.maxDate.month())) &&
            ((a = this.maxDate.month()), (t = this.maxDate.year())),
          e
            ? (this.leftCalendar.month.month(a).year(t),
              this.linkedCalendars &&
                (this.rightCalendar.month = this.leftCalendar.month
                  .clone()
                  .add(1, "month")))
            : (this.rightCalendar.month.month(a).year(t),
              this.linkedCalendars &&
      ...
      timeChanged: function (t) {
        ...
        var n,
          t = this.timePickerSeconds
            ...
            : 0;
        this.timePicker24Hour ||
          ("PM" === (e = e.find(".ampmselect").val()) && i < 12 && (i += 12),
          "AM" === e && 12 === i && (i = 0)),
          a
            ? ((n = this.startDate.clone()).hour(i),
              n.minute(s),
              n.second(t),
              this.setStartDate(n),
              this.singleDatePicker
                ? (this.endDate = this.startDate.clone())
                : this.endDate &&
                  this.endDate.format("YYYY-MM-DD") == n.format("YYYY-MM-DD") &&
                  this.endDate.isBefore(n) &&
                  this.setEndDate(n.clone()))
            : this.endDate &&
              ((n = this.endDate.clone()).hour(i),
              n.minute(s),
              n.second(t),
              this.setEndDate(n)),
          this.updateCalendars(),
